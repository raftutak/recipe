...
class CalculatorBMI extends React.Component {
  ...
  submitButton(event) {
    ...
    this.setState({
      optimalWeight:
        'Sugerowana waga dla Twojego wzrostu to od ' +
        low +
        ' kg do ' +
        high +
        ' kg.'
        ...
        <Row className="mb-4">
          <Col xs={12} md={6} lg={6}>
            <StyledForm onSubmit={this.submitButton}>
              <p className="mb-2">Wprowadź swój wzrost w centymetrach:</p>
              ...
              <p className="mb-2 mt-2">Wprowadź swoją wagę w kilogramach:</p>
          ...
          <Col xs={12} md={6} lg={6} className="mt-2">
            <StyledDescriptionContainer>
              ...
              <p className="mt-2">
                ...
                uzupełnieniem BMI jest wskaźnik ilości tłuszczu brzusznego -
                zbyt duży może oznaczać niebezpieczną otyłość brzuszną i to
                nawet przy prawidłowym BMI! Ponadto, paradoksalnie, badania
                naukowe wskazują, że osoby z lekką nadwagą zwykle są zdrowsze i
                żyją dłużej od osób z tzw. "prawidłową wagą". Pojawiają się
                nawet głosy, że ustalony arbitralnie przez WHO próg nadwagi (25)
                jest zbyt niski.
              </p>
            </StyledDescriptionContainer>
          </Col>
